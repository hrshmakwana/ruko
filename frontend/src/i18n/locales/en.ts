export const en = {
  ...
  stopWord: "STOP",
  receivedLabel: "The message you received",
  whyTitle: "Why we think so",
  consequenceTitle: "What they want to happen",
  consequenceHint: "This is the plan. It ends the same way every time.",
  scriptTitle: "If they call back, say this",
  scriptHint: "You do not owe them a conversation. Say this, then hang up.",
  teachTitle: "Remember this",
  complaintTitle: "Your complaint, ready to file",
  complaintHint: "Paste this into cybercrime.gov.in, or read it out when you call 1930.",
  copyButton: "Copy",
  copiedButton: "Copied",
